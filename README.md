...
This repository contains a web application that demonstrates end-to-end data handling and a machine learning pipeline to predict waterborne disease risk. The project is structured for clarity and showcases practical skills useful to recruiters evaluating applied ML and web development work.
